    ...
    <div>
        ...
        <div className='content'>
          <div className='wrapper'>
            {data && data.length > 0 ? (
                  ...
                  <div key={item._id} className='item'>
                    ...
                    <div className='right'>
                      ...
                      <div className='submit'>
                        ...
                        <button className='btn btn-warning' onClick={() => handleShowModal(item)}>
                          Chọn chuyến
                        </button>
                      </div>
                    </div>
              ...
              <div className='no-data'>Ngày hôm nay hiện tại không có chuyến</div>
            )}
          </div>
        </div>
      </div>
      ...
      <Modal show={showModal} onHide={handleCloseModal}>
        ...
        <Modal.Body>
          <div className='row form'>
            ...
            <div className='mb-3 col-6 item'>
              ...
              <label htmlFor='exampleFormControlInput1' className='form-label'>
                {trip?.departure?.value} - {trip?.destination?.value}
              </label>
            </div>
            <div className='mb-3 col-6 item'>
              <label htmlFor='exampleFormControlInput1' className='form-label first'>
              ...
              <label htmlFor='exampleFormControlInput1' className='form-label price'>
                {trip?.price} đ
              </label>
            </div>
            ...
            <div className='mb-3 col-6'>
              ...
              <div className='quanlity-book'>
                <label
                  onClick={() =>
                    quanlityBook > 0 ? setQuanlityBook(quanlityBook - 1) : quanlityBook
                  }
                >
                  -
                </label>
            ...
            <div className='mb-3 col-6'>
              ...
              <select selected={payment} onChange={(e) => setPayment(e.target.value)}>
        ...
        <Modal.Footer>
          ...
          <Button variant='warning' onClick={handleBookTicket}>
            Đặt vé
          </Button>
        </Modal.Footer>
      </Modal>
