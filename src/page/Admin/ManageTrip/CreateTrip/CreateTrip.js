...
const CreateTrip = (props) => {
  ...
  console.log('prop', props.carsStatus);
          ...
          <div className='bottom'>
            <div className='row'>
              ...
              <div className='mb-3 col-4'>
                ...
                <select onChange={(e) => setNewTrip({ ...newTrip, departure: e.target.value })}>
              ...
              <div className='mb-3 col-4'>
                ...
                <select onChange={(e) => setNewTrip({ ...newTrip, destination: e.target.value })}>
              ...
              <div className='mb-3 col-4'>
                ...
                <select onChange={(e) => setNewTrip({ ...newTrip, time: e.target.value })}>
              ...
              <div className='mb-3 col-4'>
                ...
                <select onChange={(e) => setNewTrip({ ...newTrip, car: e.target.value })}>
                  <option value={''}>Chọn xe</option>
                  {props.carsStatus &&
                    props.carsStatus.length > 0 &&
              ...
              <div>
                <button className='btn btn-primary col-2 my-3' onClick={() => onClickAddNewTrip()}>
                  + Thêm mới
                </button>
              </div>
            </div>
